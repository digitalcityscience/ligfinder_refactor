...
const building3D = {
    ...
    actions:{
        ...
        toggle3DBuilding({rootState, state}){
            ...
            const roofLayer = rootState.map.map.getLayer('roof');
            const wallLayer = rootState.map.map.getLayer('wall');
            if(typeof roofLayer !== 'undefined' && typeof wallLayer !== 'undefined'){
                if (state.building3DToggle == true){
                    rootState.map.map.setLayoutProperty('roof', 'visibility', 'visible');
                    rootState.map.map.setLayoutProperty('wall', 'visibility', 'visible');
                }
                else {
                    rootState.map.map.setLayoutProperty('roof', 'visibility', 'none');
                    rootState.map.map.setLayoutProperty('wall', 'visibility', 'none');
                }
            }
        }
    },
